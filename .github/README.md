...
| [![](https://img.shields.io/badge/OpenWrt-R2S_平台-32C955.svg?logo=openwrt)](https://github.com/ysx88/OpenWrt/blob/main/.github/workflows/Build-r2s（自用）.yml) | [![](https://github.com/ysx88/OpenWrt/actions/workflows/Build-r2s（自用）.yml/badge.svg)](https://github.com/ysx88/OpenWrt/actions/workflows/Build-r2s（自用）.yml) | [![](https://img.shields.io/badge/编译-配置-orange.svg?logo=apache-spark)](https://github.com/ysx88/OpenWrt/blob/main/configs/ARM/rockchip/r2s.config) | [![](https://img.shields.io/badge/下载-链接-blueviolet.svg?logo=hack-the-box)](https://github.com/ysx88/OpenWrt/releases/tag/NanoPi_R2S-自用) |
